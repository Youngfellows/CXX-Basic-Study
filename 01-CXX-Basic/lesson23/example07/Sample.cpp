...
void test3()
{
    ...
    int space = 0;//空格
    int other = 0;//其他字符
    // cout << "test3():: 大写字母:" << upper << endl;
    // cout << "test3():: 小写字母:" << lower << endl;
    // cout << "test3():: 数字字符:" << digit << endl;
    // cout << "test3():: 空格字符:" << space << endl;
    // cout << "test3():: 其他字符:" << other << endl;
...
void calculate1(char *str,int &upper,int &lower,int &digit,int &space,int &other)
{
    ...
    // cout << "calculate1()::1,大写字母:" << upper << endl;
    // cout << "calculate1()::1,小写字母:" << lower << endl;
    // cout << "calculate1()::1,数字字符:" << digit << endl;
    // cout << "calculate1()::1,空格字符:" << space << endl;
    // cout << "calculate1()::1,其他字符:" << other << endl;
